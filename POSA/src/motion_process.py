...
def convert_humanml_to_266(data):
    r_rot_quat, r_pos = recover_root_rot_pos(data)
    return torch.cat((r_rot_quat, r_pos, data[..., 4:]), dim=-1)

def recover_from_ric_from_266(data, joints_num):
    r_rot_quat, r_pos = data[..., :4], data[..., 4:7]
