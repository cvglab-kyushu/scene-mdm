...
def get_model_args(args, data):
    ...
    action_emb = 'tensor'
    cond_mode = 'text' if args.dataset in ['humanml', 'humanml_266', 'humanml_mask', 'humanml_smplx', 'babel', 'pw3d'] else 'action'
    ...
    if args.dataset in ['humanml', 'pw3d']:
        ...
        njoints = 263
        nfeats = 1
    elif args.dataset in ['humanml_266']:
        data_rep = 'hml_vec'
        njoints = 266
        nfeats = 1
    elif args.dataset in ['humanml_mask']:
        data_rep = 'hml_vec'
        njoints = 267
        nfeats = 1
    elif args.dataset in ['humanml_smplx']:
        data_rep = 'hml_vec'
        # njoints = 159
        njoints = 69
        nfeats = 1
...
def create_gaussian_diffusion(args, DiffusionClass=SpacedDiffusion):
    ...
    return DiffusionClass(
        ...
        replace_keypose=args.replace_keypose,
        lambda_vel=args.lambda_vel,
        lambda_rcxyz=args.lambda_rcxyz,
        lambda_keysmooth=args.lambda_keysmooth,
