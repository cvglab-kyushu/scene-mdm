...
def add_base_options(parser):
    ...
    group.add_argument("--replace_keypose", default=False, type=bool,
                       help="Whether to replace the key poses of the output motion during inpainting training.")
...
def add_model_options(parser):
    ...
    group.add_argument("--lambda_keysmooth", default=0.0, type=float, help="smoothing loss around key pose.")
...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='humanml', choices=['humanml', 'humanml_266', 'humanml_mask', 'humanml_smplx', 'amass', 'babel'], type=str,
...
def add_inpainting_options(parser):
    ...
    group.add_argument("--only_text_condition", default=False, action='store_true',
                       help="If true, any condition other than text is not input.")
    group.add_argument("--posa_output_path", default='', type=str, 
                       help="(POSA_output_dir)/pkl/(scene_name)/(keyframe).npy")
    group.add_argument("--motion_length", default=120, type=int,
                        help="The length of the sampled motion [in frame]. ")
...
def add_edit_inpainting_options(parser):
    ...
    group.add_argument("--text_condition", default='', type=str,
                       help="Editing will be conditioned on this text prompt. "
                            "If empty, will perform unconditioned editing.")
    group.add_argument("--show_input", default=False, action='store_true',
