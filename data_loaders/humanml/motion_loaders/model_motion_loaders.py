...
from data_loaders.humanml.motion_loaders.comp_v6_model_dataset import CompMDMGeneratedDataset, CompMDMInpaintingGeneratedDataset, \
    CompMDMUnfoldingGeneratedDataset, HumaniseDataset
...
def get_humanise_loader(args, humanise_output_dir, batch_size, data_loader):
    dataset = HumaniseDataset(args, humanise_output_dir, data_loader)
    humanise_loader = DataLoader(dataset, batch_size=batch_size)
    return humanise_loader, None
