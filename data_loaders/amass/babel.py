                    ...
                    if self.sep_to_4:
                        ...
                        if dur1 != None:
                            ...
                            if (dur_tr_valid) and (dur1_t != None):
                                ...
                                is_transition_0_T = torch.cat((torch.zeros(dur_1), torch.ones(dur_tr)))[bias_dur1_t: bias_dur1_t + dur1_t]
                        if dur2 != None:
                            frames_1_valid = True
                            ...
                            if dur_tr_valid and (dur2_t != None) :
                                ...
                                is_transition_1_T = torch.cat((torch.ones(dur_tr), torch.zeros(dur_2)))[bias_dur2_t: bias_dur2_t + dur2_t]
                    else:
